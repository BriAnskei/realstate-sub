...
import LogoIconDark from "../../icons/logo-icon-dark.svg";
...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: "On Contract", path: "/report/contract", pro: false },
    ],
  },
  {
    icon: <UserCircleIcon />,
...
const AgentSlidebar: React.FC = () => {
  ...
  // change tab nav if updating an applicaiton
  useEffect(() => {
